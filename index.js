...
app.get('/student/findOne', (req,res)=>{
  ...
  console.log("Find student with id:", id);

  Student.findOne({'_id': id}, (err, student)=>{
    if(err){
      console.log("Error in finding teacher", id);
...
app.post('/student/update', (req,res)=>{
  ...
  console.log('Update student with firstname: ' + firstname + " lastname:" + lastname);
...
app.post('/teacher/update', (req,res)=>{
  ...
  console.log('Update teacher with firstname: ' + firstname + " lastname: " + lastname);
